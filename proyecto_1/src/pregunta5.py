...
def demodulate_fsk(signal, freq_0, freq_1, symbol_duration, sample_rate):
    """Demodula una señal FSK usando FFT."""
...
def main():
    ...
    # PASO 4: Demodular
    print("\n[PASO 4] Demodulando...")
    demodulated_bits = demodulate_fsk(modulated_noisy, FREQ_BIT_0, FREQ_BIT_1, SYMBOL_DURATION, SAMPLE_RATE)
    ...
    axes[0].set_title("Bits Originales", fontsize=12, fontweight='bold')
    ...
    axes[1].set_title(f"Bits Demodulados (SNR={snr_db} dB)", fontsize=12, fontweight='bold')
    ...
    axes[2].set_title("Errores de Bit", fontsize=12, fontweight='bold')
